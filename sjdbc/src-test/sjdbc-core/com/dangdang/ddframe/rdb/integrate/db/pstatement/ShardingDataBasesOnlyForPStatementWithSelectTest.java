...
public final class ShardingDataBasesOnlyForPStatementWithSelectTest extends AbstractShardingDataBasesOnlyDBUnitTest {
    ...
    public void assertSelectEqualsWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectEqualsWithSingleTable_0.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 1000);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectEqualsWithSingleTable_1.xml", shardingDataSource.getConnection(), "t_order", sql, 12, 1201);
    ...
    public void assertSelectBetweenWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectBetweenWithSingleTable.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 1001, 1200);
    ...
    public void assertSelectInWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectInWithSingleTable_0.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 15, 1000, 1201);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectInWithSingleTable_1.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 15, 1000, 1101);
    ...
    public void assertSelectLimitWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectLimitWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2, 2);
    ...
    public void assertSelectOrderByWithAlias() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectOrderByWithAlias.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 1001, 1200);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 1309, 1408);
    }
    ...
    public void assertSelectLimitWithBindingTableWithoutOffset() throws SQLException, DatabaseUnitException {
        String sql = "SELECT i.* FROM `t_order` o JOIN `t_order_item` i ON o.user_id = i.user_id AND o.order_id = i.order_id"
                + " WHERE o.`user_id` IN (?, ?) AND o.`order_id` BETWEEN ? AND ? ORDER BY i.item_id DESC LIMIT ?";
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectLimitWithBindingTableWithoutOffset.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2);
    ...
    public void assertSelectGroupByWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectGroupByWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909);
    ...
    public void assertSelectNoShardingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectNoShardingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql);
    }
}
