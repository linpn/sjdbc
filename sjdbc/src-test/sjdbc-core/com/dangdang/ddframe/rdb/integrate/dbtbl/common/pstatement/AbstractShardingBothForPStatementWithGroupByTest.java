...
public abstract class AbstractShardingBothForPStatementWithGroupByTest extends AbstractShardingBothTest {
    ...
    public void assertSelectSum() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectSum.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
    ...
    public void assertSelectCount() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectCount.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
    ...
    public void assertSelectMax() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectMax.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
    ...
    public void assertSelectMin() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectMin.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
    ...
    public void assertSelectAvg() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectAvg.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
    ...
    public void assertSelectOrderByDesc() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/dbtbl/expect/select_group_by/SelectOrderByDesc.xml", shardingDataSource.getConnection(), "t_order", sql);
    }
}
