...
public final class ShardingTablesOnlyForPStatementWithSelectTest extends AbstractShardingTablesOnlyDBUnitTest {
    ...
    public void assertSelectEqualsWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectEqualsWithSingleTable_0.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 1000);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectEqualsWithSingleTable_1.xml", shardingDataSource.getConnection(), "t_order", sql, 11, 1109);
    ...
    public void assertSelectBetweenWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectBetweenWithSingleTable.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 1009, 1108);
    ...
    public void assertSelectInWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectInWithSingleTable_0.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 11, 15, 1009, 1108);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectInWithSingleTable_1.xml", shardingDataSource.getConnection(), "t_order", sql, 10, 12, 15, 1009, 1108);
    ...
    public void assertSelectLimitWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectLimitWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2, 2);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 10000, 2);
    }
    ...
    public void assertSelectLimitWithBindingTableWithoutOffset() throws SQLException, DatabaseUnitException {
        String sql = "SELECT i.* FROM `t_order` o JOIN `t_order_item` i ON o.user_id = i.user_id AND o.order_id = i.order_id"
                + " WHERE o.`user_id` IN (?, ?) AND o.`order_id` BETWEEN ? AND ? ORDER BY i.item_id DESC LIMIT ?";
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectLimitWithBindingTableWithoutOffset.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 0);
    }
    ...
    public void assertSelectGroupByWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectGroupByWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 11, 1000, 1109);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", shardingDataSource.getConnection(), "t_order_item", sql, 1, 9, 1000, 1909);
    }
    ...
    public void assertSelectWithBindingTableAndConfigTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectWithBindingTableAndConfigTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 11, 1009, 1108, "init");
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 11, 1009, 1108, "none");
    }
    ...
    public void assertSelectNoShardingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select/SelectNoShardingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql);
    }
}
