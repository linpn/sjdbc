...
public final class ShardingTablesOnlyForStatementWithAggregateTest extends AbstractShardingTablesOnlyDBUnitTest {
    ...
    public void assertSelectCountWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select_aggregate/SelectCountWithBindingTable_0.xml", shardingDataSource.getConnection(), "t_order_item", String.format(sql, 10, 11, 1000, 1909));
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/tbl/expect/select_aggregate/SelectCountWithBindingTable_1.xml", shardingDataSource.getConnection(), "t_order_item", String.format(sql, 1, 9, 1000, 1909));
    }
}
