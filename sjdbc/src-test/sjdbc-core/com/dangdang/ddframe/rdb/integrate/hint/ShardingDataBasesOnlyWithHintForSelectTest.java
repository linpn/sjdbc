...
public final class ShardingDataBasesOnlyWithHintForSelectTest extends AbstractShardingDataBasesOnlyHintDBUnitTest {
    ...
    public void assertSelectEqualsWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectEqualsWithSingleTable_0.xml", new DynamicShardingValueHelper(10, 1000), shardingDataSource.getConnection(), "t_order", sql, 10, 1000);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectEqualsWithSingleTable_1.xml", new DynamicShardingValueHelper(12, 1201), shardingDataSource.getConnection(), "t_order", sql, 12, 1201);
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", new DynamicShardingValueHelper(12, 1000), shardingDataSource.getConnection(), "t_order", sql, 12, 1000);
    }
    ...
    public void assertSelectBetweenWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectBetweenWithSingleTable.xml", new DynamicShardingValueHelper(Lists.newArrayList(10, 12),
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", new DynamicShardingValueHelper(Lists.newArrayList(10, 12),
    ...
    public void assertSelectInWithSingleTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectInWithSingleTable_0.xml", new DynamicShardingValueHelper(Lists.newArrayList(10, 12, 15),
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/db/expect/select/SelectInWithSingleTable_1.xml", new DynamicShardingValueHelper(Lists.newArrayList(10, 12, 15),
        ...
        assertDataSet("com/dangdang/ddframe/rdb/integrate/dataset/Empty.xml", new DynamicShardingValueHelper(Lists.newArrayList(10, 12, 15),
